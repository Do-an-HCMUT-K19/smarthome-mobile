...
class BedRoomDashboard extends StatefulWidget {
  const BedRoomDashboard({Key? key}) : super(key: key);

  @override
  State<BedRoomDashboard> createState() => _BedRoomDashboardState();
}

class _BedRoomDashboardState extends State<BedRoomDashboard> {
                      ...
                      showDatePicker(
                        ...
                        (value) {
                          if (value != null) {
                            ...
                            context
                                .read<StatisticState>()
                                .renewData(RoomType.bedRoom, value);
                          }
                        },
                      );
                    },
