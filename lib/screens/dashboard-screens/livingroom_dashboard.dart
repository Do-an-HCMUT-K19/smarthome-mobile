...
class LivingRoomDashboard extends StatefulWidget {
  const LivingRoomDashboard({Key? key}) : super(key: key);

  @override
  State<LivingRoomDashboard> createState() => _LivingRoomDashboardState();
}

class _LivingRoomDashboardState extends State<LivingRoomDashboard> {
                      ...
                      showDatePicker(
                        ...
                        (value) {
                          if (value != null) {
                            ...
                            context
                                .read<StatisticState>()
                                .renewData(RoomType.livingRoom, value);
                          }
                        },
                      );
                    },
